      ...
      <nav className="sticky top-0 z-50 bg-primary-dark/90 backdrop-blur-xl border-b border-white/[0.04]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-3 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-xl text-sm text-gray-500 hover:border-secondary/30 hover:text-gray-400 transition-all max-w-xs w-64"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <span className="flex-1 text-left">Search...</span>
            <kbd className="text-[10px] border border-gray-700 rounded px-1.5 py-0.5 text-gray-600">⌘K</kbd>
          </button>
